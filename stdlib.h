...
long int strtol(char const *STDC_RESTRICT nptr, char **STDC_RESTRICT endptr,
                int base);

long long int strtoll(char const *STDC_RESTRICT nptr,
                      char **STDC_RESTRICT endptr, int base);
...
long double strtold(char const *STDC_RESTRICT nptr,
                    char **STDC_RESTRICT endptr);

int strfromd(char *STDC_RESTRICT s, size_t n, char const *STDC_RESTRICT format,
             double fp);

int strfromf(char *STDC_RESTRICT s, size_t n, char const *STDC_RESTRICT format,
             float p);

int strfroml(char *STDC_RESTRICT s, size_t n, char const *STDC_RESTRICT format,
             long double fp);
...
size_t mbstowcs(wchar_t *STDC_RESTRICT pwcs, char const *STDC_RESTRICT s,
                size_t n);

size_t mcstombs(char *STDC_RESTRICT s, wchar_t const *STDC_RESTRICT pwcs,
                size_t n);
